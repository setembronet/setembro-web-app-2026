...
async function updateSession(request, response) {
    try {
        let supabaseResponse = response ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next({
            request
        });
        console.log('Middleware Env Check:', {
            url: ("TURBOPACK compile-time value", "https://gpgeexulpyuwomgfcpfl.supabase.co"),
            hasKey: !!("TURBOPACK compile-time value", "sb_publishable_fUkyxILv3lYC8lySFVvapg_GNRD1lIi")
        });
        ...
        return response ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next({
            request
        });
    }
}
