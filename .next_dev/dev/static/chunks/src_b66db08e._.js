...
function AgentsPage() {
        ...
        "AgentsPage.useEffect": ()=>{
            const fetchAgents = {
                "AgentsPage.useEffect.fetchAgents": async ()=>{
                    ...
                    const mockedData = data?.map({
                        "AgentsPage.useEffect.fetchAgents": (agent)=>({
                                ...agent,
    ...
    const toggleAgent = async (id, currentState)=>{
        ...
        if (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Falha ao atualizar status");
        } else {
            setAgents(agents.map((a)=>a.id === id ? {
                    ...a,
                    is_active: !currentState
                } : a));
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Status do agente atualizado");
        }
    };
    const saveAgentConfig = async ()=>{
        ...
        if (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erro ao salvar: " + (error?.message || JSON.stringify(error)));
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Configuração do Agente atualizada com sucesso!");
...
_s(AgentsPage, "uQ6qj+2FSO0lUE1z5d3dyAip9Rw=");
_c = AgentsPage;
var _c;
...
//# sourceMappingURL=src_b66db08e._.js.map